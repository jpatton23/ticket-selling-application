    ...
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <div className="flex flex-col sm:flex-row gap-4 mb-8">
        <input
          ...
          className="border border-gray-300 rounded-lg px-4 py-2 flex-1 text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500"
        />
